...
impl IVerge {
    ...
    pub async fn validate_and_fix_config() -> Result<()> {
        ...
        if needs_fix {
            ...
            help::save_yaml(&config_path, &config, Some("# YIZ Gateway Config")).await?;
    ...
    pub fn template() -> Self {
        Self {
            ...
            #[cfg(feature = "yiz-edition")]
            verge_mixed_port: Some(7887),
            #[cfg(not(feature = "yiz-edition"))]
            verge_mixed_port: Some(7897),
            #[cfg(feature = "yiz-edition")]
            verge_socks_port: Some(7888),
            #[cfg(not(feature = "yiz-edition"))]
            verge_socks_port: Some(7898),
            verge_socks_enabled: Some(false),
            #[cfg(feature = "yiz-edition")]
            verge_port: Some(7889),
            #[cfg(not(feature = "yiz-edition"))]
    ...
    pub async fn save_file(&self) -> Result<()> {
        help::save_yaml(&dirs::verge_path()?, &self, Some("# YIZ Gateway Config")).await
    }
